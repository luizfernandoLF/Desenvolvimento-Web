...
app.engine("handlebars", engine({
  helpers: {
    ...
    eq: require(`${process.cwd()}/src/views/helpers/helpers`).eq
  },
...
app.set("views", [
  path.join(process.cwd(), 'src', 'views', 'main'),
  path.join(process.cwd(), 'src', 'views', 'major'),
  path.join(process.cwd(), 'src', 'views', 'user')
]);
