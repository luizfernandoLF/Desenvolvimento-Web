...
router.get('/signup', mainController.signup as unknown as RequestHandler);
router.post('/signup', mainController.signup as unknown as RequestHandler); // Para processar o formulário
